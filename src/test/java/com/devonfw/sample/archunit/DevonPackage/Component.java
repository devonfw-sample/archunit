...
public class Component {
    ...
    /**
     * @param nonTransitiveDependencies new value of
     *                                  {@link #getNonTransitiveDependencies()}.
     */
    ...
    /**
     * @param dependentComponentName the {@link #getName() name} of the dependent
     *                               {@link Component}.
     * @return {@code true} if this {@link Component} has a
     *         {@link #getDependencies() defined dependency} on the
     *         {@link Component} with the given {@link #getName() name},
    ...
    public boolean hasDependency(String dependentComponentName) {
        ...
        if (this.allDependencies != null) {
            ...
            if ((this.nonTransitiveDependencies != null)
                    && this.nonTransitiveDependencies.contains(dependentComponentName)) {
                return true;
            }
    ...
    /**
     * @return the {@link Set} of transitive dependencies including
     *         {@link #getNonTransitiveDependencies() non-transitive
     *         dependencies} as well as {@link #getDependencies() declared and
     *         transitive dependencies} (recursively). Is
     *         calculated outside of this bean and does not map to JSON. Will be
     *         {@code null} until
