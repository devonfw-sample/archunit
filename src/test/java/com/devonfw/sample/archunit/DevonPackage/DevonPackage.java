...
public interface DevonPackage {
     ...
     *         to the
     *         {@link com.devonfw.sample.archunit.DevonPackage.ide.sonarqube.common.api.config.Packages}
     *         definition of the architecture
     *         {@link com.devonfw.ide.sonarqube.common.api.config.Configuration},
    ...
    /**
     * @return the {@link #composePackage(String, String) package-fragment composed}
     *         of {@link #getComponent() component}
    ...
    /**
     * @return {@code true} if the {@link #getLayer() layer} is a valid devon4j
    ...
    /**
     * @return {@code true} if the {@link #getScope() scope} is a valid devon4j
     ...
     *         empty {@link String} if not present. Otherwise it will include the
     *         leading dot (e.g. ".foo.bar").
     */
    String getDetail();
