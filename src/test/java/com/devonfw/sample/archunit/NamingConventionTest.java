...
public class NamingConventionTest {
   ...
   * ending with 'Cto'.
   */
  public static final ArchRule N1DevonNamingConventionCtoCheck = classes().that().areAssignableTo(AbstractCto.class)
   ...
   */
  public static final ArchRule N3DevonNamingConventionEntityCheck = classes().that()
   ...
   */
  public static final ArchRule N4DevonNamingConventionEtoCheck = classes().that().areAssignableTo(AbstractEto.class)
   ...
   */
  public static final ArchRule DevonAbstractUcCheck = classes().that().areAssignableTo(AbstractUc.class).should()
   ...
   * Mapper
   */
  public static final ArchRule DevonMapperCheck = classes().that().areAnnotatedWith(Mapper.class).should()
   ...
   * Service
   */
  public static final ArchRule DevonPathCheck = classes().that().areAnnotatedWith(Path.class).should()
   ...
   */
  public static final ArchRule DevonJpaRepositoryCheck = classes().that().areAssignableTo(JpaRepository.class).should()
   ...
   */
  public static final ArchRule N5DevonNamingConventionUcCheck = classes().that().areAssignableTo(AbstractUc.class).and()
