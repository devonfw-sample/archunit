...
public class ComponentRuleC4LayerService2Logic4ComponentTest {
    ...
    static ArchCondition<JavaClass> haveNonCompliantComponentDependencies = new ArchCondition<JavaClass> ("have dependencies, towards another components logic layer (Rule-C4).") {
        @Override
